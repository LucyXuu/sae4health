...
## Fork and clone the SAE4Health package

Frok the most up to date repo of SAE4Health from https://github.com/wu-thomas/sae4health and clone the repo to local computer
...
Some data, such as county recode data and other country meta data, are saveing in an online server for the app to fetch from. Setup a local server and store a part of the data to locally test functionality and connection to server.
...
All server data is stored in dropbox, ask Jon for access if needed. It will also be helpful to see the dropbox folder structure of data to know where to place the folders and files
